...
1. [Requirements](https://wdzajicek.github.io/kcc-dev-docs/#requirements)
  - [Mac](https://wdzajicek.github.io/kcc-dev-docs/#mac):
    - [RVM](https://wdzajicek.github.io/kcc-dev-docs/#1-rvm-using-ruby-250----httpsrvmiorvminstall):
      - [Installation](https://wdzajicek.github.io/kcc-dev-docs/#1-rvm-using-ruby-250----httpsrvmiorvminstall)
      - [Install ruby-2.5.0](https://wdzajicek.github.io/kcc-dev-docs/#1-rvm-using-ruby-250----httpsrvmiorvminstall)
      - [Set ruby-2.5.0 as default](https://wdzajicek.github.io/kcc-dev-docs/#1-rvm-using-ruby-250----httpsrvmiorvminstall)
    - [NVM](https://wdzajicek.github.io/kcc-dev-docs/#2-nvm-using-node-version-961---httpsgithubcomcreationixnvm):
      - [Installation](https://wdzajicek.github.io/kcc-dev-docs/#2-nvm-using-node-version-961---httpsgithubcomcreationixnvm)
      - [Install Node Version 9.6.1](https://wdzajicek.github.io/kcc-dev-docs/#2-nvm-using-node-version-961---httpsgithubcomcreationixnvm)
    - [NPM 6.1.0](https://wdzajicek.github.io/kcc-dev-docs/#3-npm-version-610)
    - [Jekyll](https://wdzajicek.github.io/kcc-dev-docs/#4-jekyll-and-bundler---httpsjekyllrbcomdocsinstallation)
    - [Gulp](https://wdzajicek.github.io/kcc-dev-docs/#6-gulp---httpsgulpjscom)
  - [Windows PC](https://wdzajicek.github.io/kcc-dev-docs/#windows-pc):
    - [Enable "Windows Subsystem for Linux"](https://wdzajicek.github.io/kcc-dev-docs/#1-install-the-windows-subsystem-for-linux---run-in-powershell-as-administrator)
    - [Install Ubuntu in the Microsoft Store](https://wdzajicek.github.io/kcc-dev-docs/#2-install-ubuntu-in-the-microsoft-store)
    - [Git SCM](https://wdzajicek.github.io/kcc-dev-docs/#3-git-scm---httpsgit-scmcom)
    - [RVM](https://wdzajicek.github.io/kcc-dev-docs/#4-rvm-using-ruby-250----httpsrvmiorvminstall):
      - [Installation](https://wdzajicek.github.io/kcc-dev-docs/#4-rvm-using-ruby-250----httpsrvmiorvminstall)
      - [Install ruby-2.5.0](https://wdzajicek.github.io/kcc-dev-docs/#4-rvm-using-ruby-250----httpsrvmiorvminstall)
      - [Set ruby-2.5.0 as default](https://wdzajicek.github.io/kcc-dev-docs/#4-rvm-using-ruby-250----httpsrvmiorvminstall)
    - [NVM](https://wdzajicek.github.io/kcc-dev-docs/#5-nvm-using-node-version-961---httpsgithubcomcreationixnvm):
      - [Installation](https://wdzajicek.github.io/kcc-dev-docs/#5-nvm-using-node-version-961---httpsgithubcomcreationixnvm)
      - [Install Node Version 9.6.1](https://wdzajicek.github.io/kcc-dev-docs/#5-nvm-using-node-version-961---httpsgithubcomcreationixnvm)
    - [NPM 6.1.0](https://wdzajicek.github.io/kcc-dev-docs/#6-npm-version-610)
    - [Jekyll](https://wdzajicek.github.io/kcc-dev-docs/#7-jekyll-and-bundler---httpsjekyllrbcomdocsinstallation)
    - [Travis-CLI](https://wdzajicek.github.io/kcc-dev-docs/#8-travis-cli---httpsdocstravis-cicomuserencryption-keysstqstp0)
    - [Gulp](https://wdzajicek.github.io/kcc-dev-docs/#9-gulp---httpsgulpjscom)
2. [Local Installation](https://wdzajicek.github.io/kcc-dev-docs/#local-installation)
	- [install.sh](https://wdzajicek.github.io/kcc-dev-docs/#local-installation)
		- [Gemfile](https://wdzajicek.github.io/kcc-dev-docs/#local-installation)
		- [Bundle install](https://wdzajicek.github.io/kcc-dev-docs/#local-installation)
		- [npm install](https://wdzajicek.github.io/kcc-dev-docs/#local-installation)
3. [Development](https://wdzajicek.github.io/kcc-dev-docs/#development)
    - [The build](https://wdzajicek.github.io/kcc-dev-docs/#development)
    - [Browsersync](https://wdzajicek.github.io/kcc-dev-docs/#development)
    - [watch](https://wdzajicek.github.io/kcc-dev-docs/#watch)
3. [Travis CI](https://wdzajicek.github.io/kcc-dev-docs/#travis-ci)
  - [Travis Configuration File](https://wdzajicek.github.io/kcc-dev-docs/#travis-configuration-file-travisyml):
    - [before_install](https://wdzajicek.github.io/kcc-dev-docs/#before_install)
    - [install](https://wdzajicek.github.io/kcc-dev-docs/#install)
    - [Branches](https://wdzajicek.github.io/kcc-dev-docs/#branches)
    - [Notifications](https://wdzajicek.github.io/kcc-dev-docs/#notification-settings-with-encrypted-emails)
    - [before_script](https://wdzajicek.github.io/kcc-dev-docs/#before_script)
    - [script](https://wdzajicek.github.io/kcc-dev-docs/#script)
    - [after_success](https://wdzajicek.github.io/kcc-dev-docs/#after_succes)
    - [Global Environment Variables](https://wdzajicek.github.io/kcc-dev-docs/#global-environment-variables)
  - [Encrypting Using Travis CLI](https://wdzajicek.github.io/kcc-dev-docs/#encrypting-using-travis-cli)
  - [Encrypting Notification emails](https://wdzajicek.github.io/kcc-dev-docs/#encrypting-notification-emails)
  - [Encrypting and Calling Environment Variables](https://wdzajicek.github.io/kcc-dev-docs/#encrypting-and-calling-environment-variables)

## Requirements

<span style="float: right; position: relative; top: -4rem;"><a href="https://wdzajicek.github.io/kcc-dev-docs/#contents">Contents</a></span>
...
<a href="https://wdzajicek.github.io/kcc-dev-docs/#contents" style="float: right; position: relative; top: -4.5rem;">Contents</a>
...
##### See [Encrypting Notification Emails](https://wdzajicek.github.io/kcc-dev-docs/#encrypting-and-calling-environment-variables)
...
##### See [Encrypting and Calling Environment Variables](https://wdzajicek.github.io/kcc-dev-docs/#encrypting-and-calling-environment-variables).
...
<span style="float: right;"><a href="https://wdzajicek.github.io/kcc-dev-docs/#contents">Contents</a></span>
